...
// GetOptionsByLessonAndScreenId retrieves Options by Lid and Sid. Returns error if
// Id doesn't exist
func GetOptionsByLessonAndScreenId(lid int, sid int) (v *Options, err error) {
	o := orm.NewOrm()
	l := &Lessons{Id: lid}
	s := &Screens{Id: sid}
	v = &Options{LessonId: l, ScreenId: s}
	if err = o.Read(v); err == nil {
		return v, nil
	}
	return nil, err
